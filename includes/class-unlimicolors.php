...
class UNLIMICOLORS {
	...
	public function __construct() {
		if ( defined( 'UNLIMICOLORS_VERSION' ) ) {
			$this->version = UNLIMICOLORS_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	...
	private function load_dependencies() {
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/unlimiCore/class-unlimicolors-core.php';

		/**
		 * The class responsible for orchestrating the actions and filters of the
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-unlimicolors-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-unlimicolors-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-unlimicolors-admin.php';
	...
	private function set_locale() {
		...
		$plugin_i18n = new Unlimicolors_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Unlimicolors_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Unlimicolors_Public( $this->get_plugin_name(), $this->get_version() );
